package ua.hillel.cases.api;

import io.restassured.response.Response;
import org.hamcrest.MatcherAssert;
import org.testng.annotations.Test;
import ua.hillel.api.dto.BookingDTO;
import ua.hillel.api.dto.BookingIdDTO;
import ua.hillel.api.dto.BookingResponseDTO;
import ua.hillel.api.services.BookingService;
import ua.hillel.testData.AppTestData;
...
public class BookingApiTest {
    ...
    public void checkNewBookingCreation() {
        BookingDTO expectedBooking = AppTestData.buildDefaultBookingData(false);
